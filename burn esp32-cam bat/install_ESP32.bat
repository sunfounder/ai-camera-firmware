...
esptool.exe --chip esp32 --before default_reset erase_flash
esptool.exe --chip esp32 --before default_reset write_flash -z --flash_mode dio --flash_freq 80m --flash_size 4MB 0x0000 %merge_app%
